...
for region in `cat config/directories.in`; do
    cd ${Directory}/${region}
	hadd normalizedHistos_${SAMPLE}.root normalizedHistos_${SAMPLE1}.root normalizedHistos_${SAMPLE2}.root normalizedHistos_${SAMPLE3}.root normalizedHistos_${SAMPLE4}.root normalizedHistos_${SAMPLE5}.root 
	cd ../../
done    
